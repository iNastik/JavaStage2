...
public class FileParser {
    ...
    public void countAverageFilesNumberInFolder(List<String> fileStrings) {
        ...
        double averageFilesNumberInFolder = (double) filesNumber/foldersNumber;
        System.out.println("Average files number in folder is " + Precision.round(averageFilesNumberInFolder, 1));
    }
    ...
    public void countAverageFileNameLength(List<String> fileStrings) {
        ...
        System.out.println("Average length of the file name is " + Precision.round(averageFileNameLength, 1));
    }
}
