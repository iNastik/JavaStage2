...
public class Task10 {
    public static void main(String[] args) throws IOException {
        ...
        File outputFile = taskUtility.createNewFile(directoryPathName + "\\Task10.txt");
        try (OutputStream outputStream = new FileOutputStream(outputFile);
             OutputStreamWriter outputStreamWriter = new OutputStreamWriter(outputStream);
             BufferedWriter bufferedWriter = new BufferedWriter(outputStreamWriter)) {
            task10.swapFirstAndLastWordsInEachLine(fileStrings, bufferedWriter);
        }
    }


    public void swapFirstAndLastWordsInEachLine(List<String> fileStrings, BufferedWriter bufferedWriter) throws IOException {
